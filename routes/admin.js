...
//get cars list
router.get("/cars/:id", requireSignin, isAuth, isAdmin, getCarsListByAdmin);
...
//get canceled commands by admin
router.get("/canceled-commands/:id", requireSignin, isAuth, isAdmin, getCanceledCommandsByAdmin);
